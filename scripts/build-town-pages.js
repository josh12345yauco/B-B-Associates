...
/* ── Sitemap upsert ──────────────────────────────────────────── */
function updateSitemap(urls, marker = '  <!-- Service × Town Pages (generated by scripts/build-town-pages.js) -->', priority = '0.80') {
...
module.exports = { buildPage, TOWNS, SERVICES, pageUrl, updateSitemap,
  blocks: { gtmHead, gtmBody, nav, footer, businessSchema, faqSchema, ld, esc, attr, absUrl, SITE, CSS, EXTRA_CSS, projectById, articleById } };
